...
public class buy_goods extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_buy_goods, container, false);

        bt1 = (Button) view.findViewById(R.id.next_s);
        bt2 = (Button) view.findViewById(R.id.pre_b);
        ...
        final TextView tv_id = (TextView) view.findViewById(R.id.Id_no);

        my_data = FirebaseDatabase.getInstance().getReference("goods_to_sell");
        DatabaseReference chi = my_data.child("goods0");
            ...
            public void onClick(View arg0) {
                ...
                my_data.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        goods x = dataSnapshot.child("goods"+num).getValue(goods.class);
