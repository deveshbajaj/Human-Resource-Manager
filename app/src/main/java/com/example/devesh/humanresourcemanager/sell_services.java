...
public class sell_services extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sell_services, container, false);
        bt1 = (Button) view.findViewById(R.id.publish_service);
        ed1_N = (EditText) view.findViewById(R.id.S_name);
        ed2_P = (EditText) view.findViewById(R.id.S_price);
        ed3_D = (EditText) view.findViewById(R.id.S_details);
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                my_data .child("servies"+s).setValue(g1);
                Toast.makeText(getActivity(),"Service Published",Toast.LENGTH_SHORT).show();
                ed1_N.setText(" ");
                ed2_P.setText(" ");
                ed3_D.setText(" ");
            }
